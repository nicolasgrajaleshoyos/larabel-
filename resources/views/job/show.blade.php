  ...
  <main class="max-w-4xl mx-auto px-4 py-6">
    ...
    <div class="bg-gray-800 rounded-lg shadow-2xl p-8 border border-gray-700">
      ...
      <div class="border-t border-gray-700 pt-6 mt-6">
        <a href="/empleos/{{ $empleo->id }}/edit" class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg shadow-lg transition duration-200 ease-in-out transform hover:scale-105">
          <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
